...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //metodo para preencher banco de dados do projeto automatico
        public void Seed()
        {
            //if que verifica se tem algum dado na tabela do banco de dados se estiver ele ira pra o script
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return; //o banco de dados ja esta preenchido
            }
